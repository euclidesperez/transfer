...
$("body").on("click", ".has-detail-view .list-item", function(e){
	$(e.target).closest(".list").addClass("open-detail-view");
});

$("body").on("reset", ".has-detail-view form", function(e){
	$(e.target).closest(".list").removeClass("open-detail-view");
});
